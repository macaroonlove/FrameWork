...
//{
//    [System.Serializable]
//    public class NGUISpriteAlphaTweenCommand : TweenCommand
//    {
...
//                {
//                    tween = Tween.Custom(targets[i], targets[i].alpha, finalAlpha, finalDuration, (t, val) => t.alpha = val, animationCurve, startDelay: startDelay);
//                }
//                else
//                {
//                    tween = Tween.Custom(targets[i], targets[i].alpha, finalAlpha, finalDuration, (t, val) => t.alpha = val, (Ease)selectedEaseOrCurve, startDelay: startDelay);
//                }
...
//                for (int i = 0; i < targets.Length; i++)
//                {
//                    if (targets[i] != null) _startAlphas[i] = targets[i].alpha;
//                }
//                return;
//            }
...
//                    else if (targets[i] != null) newStarts[i] = targets[i].alpha;
//                }
...
//                {
//                    targets[i].alpha = _startAlphas[i];
//                }
//            }
//        }

//#if UNITY_EDITOR
//        public override string GetDescription() => "NGUI 투명도 (Alpha)";
